...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <div class="container flex justify-content-between">
    <a class="navbar-link" href="{{ route('home') }}">
        <img src="{{ url('assets/images/logo.png') }}" alt="logo" class="h-32px" srcset="">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex w-100 my-2 my-lg-0 me-4" role="search" action="#" method="GET">
        <div class="input-group">
            <span class="input-group-text bg-white border-end-0">
                <img src="{{ url('assets/images/search.png') }}" alt="search" srcset="">
            </span>
      ...
      <ul class="navbar-nav ms-auto my-2 my-lg-0 text-center ">
        <li class="nav-item my-auto">
          <a class="nav-link  btn-primary text-nowrap" href="#">Log In</a>
        </li>
